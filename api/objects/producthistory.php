...
";
    ...
    public $id,$name,$productId,$sizeAttributetId,$price,$colorAttributeId,$sizeAttributeId,$skuId,$quantity,$trending,$arrival,$bestselling,$categoriesId,$createdOn,$updatedOn,$createdBy,$summary,$sellarId;
    ...
    {
       $query = " Select name,categoriesId,description,image,sellarId,skuId,price,discount from " . $this->producthistory;
         $stmt = $this->conn->prepare($query);
        //  $stmt->bindParam(":skuId", $this->skuId); 
        $stmt->execute();
        return $stmt;
