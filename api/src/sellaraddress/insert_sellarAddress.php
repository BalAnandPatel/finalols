...
include_once '../../objects/sellaraddress.php';
...
$insert_sellarAddress = new Sellaraddress($db);
...
{
    $insert_sellarAddress->sellarId = $data->sellarId;
    $insert_sellarAddress->createdOn = $data->createcOn;
    $insert_sellarAddress->createdBy = $data->createdBy;

       
    //var_dump($exam);
    // create the reg
    if($insert_sellarAddress->insertSellarAddress()){

        http_response_code(201);
        echo json_encode(array("message"=>"sellar Address Insert Succsess"));
